...
class StudentProfileTable extends React.Component {
    state = {
        profiles: [],
        departmentList: [],
        selectedDepartment: '',
    ...
    componentDidMount() {
        ...
        axios.get('http://127.0.0.1:8000/api/main/StudentProfileList/')
            .then(res => {
                ...
                axios.get('http://127.0.0.1:8000/api/main/StudentTagsList/')
                    .then(res => {
    ...
    onFinish = values => {
        ...
        axios.post('http://127.0.0.1:8000/api/main/StudentProfileList/search/', {
